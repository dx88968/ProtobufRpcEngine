...
import CoreProtos.RequestHeaderProtos.RequestHeaderProto;
import CoreProtos.RequestHeaderProtos.ResponseHeaderProto;
...
import io.DataOutputOutputStream;
import io.Writable;
...
public class ProtobufRpcEngine implements RpcEngine{
  ...
  private static class Invoker implements InvocationHandler{
    ...
    @Override
    public RPCServer getServer(Class<?> protocol, Object instance, String bindAddress, int port, int numHandlers, int numReaders, int queueSizePerHandler, boolean verbose, String portRangeConfig) throws IOException {
